...
BOT_NAME = getenv("BOT_NAME", "JESUS MUSIC")
API_ID = int(getenv("API_ID", "12569469"))
API_HASH = getenv("API_HASH", "c6bcd3159dd8a1e4cf3f48f34e9e9328")
OWNER_NAME = getenv("OWNER_NAME", "JESUS")
OWNER_USERNAME = getenv("OWNER_USERNAME", "IEBIE")
ALIVE_NAME = getenv("ALIVE_NAME", "muntazer")
BOT_USERNAME = getenv("BOT_USERNAME", "Micclallbot")
OWNER_ID = getenv("OWNER_ID", "1421137574")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "JESUS")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "TTUT2")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "TTUT2")
